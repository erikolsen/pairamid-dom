                ...
                <div className='bg-white shadow-lg rounded-lg border border-black m-2 p-4'>
                    <div className='flex'>
                        <p>
                            ...
                            you accept responsibility for any content submitted and actions taken while using the product.
                            You are advised to not share organizationally identifiable information. <i>Effective starting: April 26th, 2021</i>
                        </p>
