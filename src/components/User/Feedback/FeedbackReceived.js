...
const FeedbackReceived = ({
  ...
  const GLOWS_AND_GROWS_GROUP = user.feedback_tag_groups.filter(
  ...
  const glowGrowData = _.uniq(
    feedbackTags.filter(filterGroup(GLOWS_AND_GROWS_GROUP))
  ).map((tagName) => ({
    name: tagName,
